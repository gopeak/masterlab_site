        ...
        function createCopyRightPage2() {
            try {
                if (getCanShowCopyrightPageEnd() && 0 === _dataObj.result && !isOldWsite()) {
                    ...
                    var a = "";
                    _isWxMin ? getIsFromTpl() || (a = '<div class="view-more"> <a class="view-more-button mini-home-button" href="javascript:void(0)"></a> </div>') : a = '<div class="view-more"> <a class="view-more-button" href="' + getMakeRRxUrl() + '" target="_blank"></a> </div>';
