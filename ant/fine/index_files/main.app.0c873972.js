var rrxCommConfig = {version: "v4.7.9", viewDomainFormat: "http://m.rrxiu.net/?v={guid}", wxMinDomain: "min.rrxiu.net"},
    appConfig = {
        ...
        copyrightPage: {
            ...
            elementList: [{
                ...
                content: {
                    css: "",
                    fullscreen: !0,
                    html: ' <div class="copyright-content"> <div class="rrx-icon-close-layer"> </div> <div class="share-image"> <img src="{{shareImageUrl}}"> </div> <div class="share-title">{{shareTitle}}</div> <div class="view-more"> <a class="view-more-button" href="#" target="_blank"></a> </div> <a href="javascript:void(0)" class="show-rrxiu-report" ></a> <div class="bottomm-text" style="{{bgBottomColor}}"> <a class="make-rrxiu" href="http://mp.weixin.qq.com/s?__biz=MzA4ODc5OTE1OQ==&mid=403178211&idx=1&sn=9c50c942df41020d626d50289a75cf16#rd" target="blank"> <span>   </span> </a> </div> <a href="javascript:void(0)" class="show-rrxiu-visit" style="color:{{visitColor}};display:{{showVisitCount}}"></a> </div>',
                    scroll: !1
                },
                display: !0,
                height: 1010,
...
$(function () {
        ...
        Cool.util.loadJs([e], function (e) {
            try {
                if ("1" !== wsiteInfo.mamfm && "0" === wsiteInfo.wxp.newReview && (coolData = {
                        result: 403,
                        msg: "审核不通过"
                    }), "" === coolData && B === !1) a(x), B = !0; else {
                    if (0 === coolData.result) {
                        var g = Cool.util.getUrlParameterByName("from_code"),
                            h = Cool.util.getUrlParameterByName("qrc_code"), i = c();
                        C = new WePlusLog(b(), l, g, h, n, i);
                        var k = d(coolData);
                        !k.pageList || null !== k.pageList[0] && void 0 !== k.pageList[0] || (console.log(404), coolData.result = 404, coolData.msg = "活动不存在")
                    ...
                    $("#main").css({width: width, height: height}), "1" === m && (coolData.showVisitCount = !1);
                    var o = b(), p = new RRXTachograph(o, l, n);
                    j = new CoolApp, j.createApp(o, $("#main"), coolData, Cool.util.checkIsPcWithoutIframe(), v, C, !1, "1" === n ? !0 : !1, "1" === m ? !0 : !1, {}, q, p), f()
                }
            } catch (r) {
                a(x), B = !0, console.log("load", r)
            }
        })
    }
    ...
    function b() {
        ...
        if (q) return appConfig.serviceHost;
    ...
    function c() {
        ...
        if (q) return appConfig.interactServiceHost;
    ...
    function e() {
        ...
        if (q) return appConfig.cloudHost;
    ...
    function f() {
        var a = function (a) {
            ...
            if ("" !== c) {
                ...
                if ("next" === c.filpType) j.getAllowFlip() && j.nextPage(); else if ("pre" === c.filpType) j.getAllowFlip() && j.prePage(); else if ("copyright" === c.filpType || "setting" === c.filpType) {
                    var e = $.extend(coolData, {}, !0), f = c.wsite, g = c.copyright;
                    for (var h in f) e[h] = f[h];
                    void 0 !== g && ("customer" === g.from && (e.copyright = appConfig.copyright), e.copyright.from = g.from), e.showVisitCount = !1, j = new CoolApp;
                    var i = e.pageList[e.pageList.length - 1].id;
                    j.getApiHelper().setStartPage(i), $("#main").find(".pt-wrapper .pt-pagelist").html("");
    ...
    function g() {
        for (var a = window.location.href, b = a, c = !1, d = 0; d < r.length; d++) a.indexOf(r[d] + "=") > -1 && (c = !0, b = Cool.util.removeUrlPara(b, r[d]));
        c && window.history.pushState({}, 0, b)
    }

    function h() {
        if (appConfig.dev) return appConfig.libHost;
        if (q) return appConfig.libHost;
    ...
    "undefined" != typeof AmdLoader && AmdLoader.config({
        ...
        baseUrl: i,
        paths: {"rrxiu/pluginUtils": i + "rrxiu/pluginUtils.js"}
    });
    var j, k = Cool.util.checkIsPc(), l = wsiteInfo.wsiteGuid, m = Cool.util.getUrlParameterByName("setting"),
        n = Cool.util.getUrlParameterByName("preview"), o = Cool.util.getUrlParameterByName("tpl"),
        p = Cool.util.getUrlParameterByName("mwa"), q = window.rrxWxMin = "1" === p ? !0 : !1;
    (window.location.href.indexOf(rrxCommConfig.wxMinDomain) > -1 || 2 === wsiteInfo.rrxfp) && !q && (window.location.href = appConfig.viewDomainFormat.replace("{guid}", wsiteInfo.wsiteGuid)), window.rrxDanmuJump = "danmu" === Cool.util.getUrlParameterByName("clickType"), window.rrxBrowserParams = {};
    for (var r = ["orderNo", "checkpay", "uid", "stid", "eid"], s = 0; s < r.length; s++) window.rrxBrowserParams[r[s]] = Cool.util.getUrlParameterByName(r[s]);
    if (window.startPageId = Cool.util.getUrlParameterByName("stid"), void 0 === window.startPageId || null === window.startPageId || "" === window.startPageId) {
        var t = "rfstid" + l, u = Cool.cookie.get(t);
        u && (window.startPageId = u, Cool.cookie.clear(t))
    }
    g(), k || (document.addEventListener("touchmove", function (a) {
        a.preventDefault()
    }, !1), $("#main").on("touchmove", function (a) {
        a.preventDefault()
    }));
    var v = Cool.util.checkIsWeixin(), w = "", x = b() + "view/data?id=" + l + "&preview=" + n;
    "1" === wsiteInfo.mamfm && (x += "&mamfm=1"), "1" === wsiteInfo.mamcg && (x += "&mamcg=1"), "1" === wsiteInfo.mamsp && (x += "&mamsp=1", x = x + "&mamsphis=" + wsiteInfo.mamsphis);
    var y = e() + l + ".js", z = wsiteInfo.ver;
    if (o) x = x + "&tpl=" + o, y = e() + "tpl_" + l + ".js?v=" + z, a(appConfig.enabledCloud ? y : x); else {
    ...
    var B = !appConfig.enabledCloud, C = null
});
var CssAnimationEngine = function () {
    ...
    function h(a, b, c, d, e, f, g, h, i) {
        ...
        1e3 === d && l > 30 && (d *= Math.ceil(l / 30)), d /= l, a.find(".textanimation").each(function (a, b) {
            var e = 0;
...
}(window), window.UseAmdLoaderPlugin = function (a, b) {
    var c = ["演示插件11", "卡片10", "照片投票12", "秒杀10", "商品秒杀10", "定时抽奖10"];
    return c.indexOf(a + b) > -1 ? !0 : !1
};
var Cool = {
    share: {
        ...
        getUrlParameterByName: function (a) {
            ...
            try {
                ...
                g.onload = function () {
                    ...
                    console.log("error", a), void 0 !== b && b(null)
                }
            } catch (h) {
            }
            ...
            var d = "@!user_image_";
            if (c = c || "", b = b || "", "100%" === a) return d + "600x1";
            if (a = parseInt(a, 10), 0 >= a || isNaN(a)) return d + "600x1";
            var e = Math.floor(a / 100);
            return "imggroup" === b && Cool.util.checkIsIphone() && (e = Math.floor(a / 100), e > 3 && (e = 3)), 10 >= e ? (e > 5 && (e -= 1), d + 100 * e + "x1") : d + "800x1"
...
window.rrxOpenWsiteTime = (new Date).getTime(), window.userReadDepth = 1, window.rrxdebug = !1, window.CoolApp = {}, window.qqMapCallback = function () {
    ...
    CoolApp = function () {
        ...
        function parseElement(a, b) {
            ...
            if (s.attr("style", c), s.css("transform", ""), s.css("-webkit-transform", ""), s.attr("eletype", a.type), _isPageThumb || s.attr("data-id", a.id), "img" == a.type) {
                ...
                var K = null;
                a.isLongText && (_isEditing ? s.find(".element-box").css({overflow: "auto"}) : (K = s.find(".element-last"), K.css({overflow: ""}))), a.textStroke && (K || (K = s.find(".element-last")), a.textStroke.display ? K.css("-webkit-text-stroke", a.textStroke.width + "px " + a.textStroke.color) : K.css("-webkit-text-stroke", "0")), _isEditing && /Safari/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) && (console.log("browser:safari"), K || (K = s.find(".element-last")), K.css("-webkit-user-select", "auto"))
        ...
        function getPageInputSelect(a) {
            ...
            if ("input" === b) {
                ...
                if ("city" == b) {
                    var m = $page.find(".element_" + c + " .time-select").length;
                    console.log("value", e), console.log("_optionCount", m);
                    var n = e.split("-"), o = "请选择" + f, p = n.length, q = !1;
                    if (p > 0) {
                        m > 1 && (m = 1);
                        for (var r = 0, s = 0; p > s; s++) "" !== n[s] && r++;
                        m > r && (q = !0, o = (r > 0 ? "请完善" : "请选择") + f)
                    } else q = !0;
                    if (q) return {result: 1, msg: o}
                } else if ("multiselect" == b && e.split(",").length < 2) return {result: 1, msg: "请完善" + f}
            }
            var t = {};
            return t.id = c, t.value = e, t.type = b, t.unique = a.unique, t
        }
                    ...
                    if (e.attr("src", f), void 0 === a.backgroundView) {
                        ...
                        if (p = Math.ceil(_$canvas.width() / _pt_inner_scale_value), q = Math.ceil(_$canvas.height() / _pt_inner_scale_value), testAlert("_pt_inner_scale_value" + _pt_inner_scale_value), testAlert("canvas-w" + _$canvas.width()), testAlert("canvas-h" + _$canvas.height()), j) {
                            ...
                            a.backgroundImageNaturalWidth === a.backgroundView.width ? (testAlert("NaturalWidth " + a.backgroundImageNaturalWidth),
                                testAlert("viewWidth " + a.backgroundView.width), r = a.backgroundView.width / p, l = p, m = l / k) : (r = a.backgroundView.width / p, l = a.backgroundImageNaturalWidth / r, m = l / k), o = void 0 === a.backgroundView ? 0 : a.backgroundView.x / r, n = void 0 === a.backgroundView ? 0 : a.backgroundView.y / r
                        } else {
                            var s = 1010;
        ...
        function showTopMenu() {
            if (void 0 !== _dataObj.topMenu) {
                if (0 === $topMenuPanel.find(".top-menu-list").length) {
                    ...
                    b && (a += '<a class="menu-focus" href="javascript:void(0)">关注公众号</a>'), a += "</div></div></div>", a += "customer" === _copyrightFrom ? '<div class="menu-copyright">' + getCopyrightCustomer(!0) + '<span class="show-report">举报</span></div>' : "na" === _copyrightFrom ? '<div class="menu-copyright"></div>' : '<div class="menu-copyright"><span class="show-report">举报</span><span class="show-copyright"><a href="' + getMakeRRxUrl() + '" target="_blank" style="color:#fff;">' + appConfig.copyright.content + "</a></span></div>", $topMenuPanel.html(a), "na" !== _copyrightFrom && registerReportEvent($topMenuPanel.find(".menu-copyright .show-report")), _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function () {
        ...
        function createDanmuPanel() {
            ...
            "customer" !== _copyrightFrom && "na" !== _copyrightFrom && (_isWxMin || (b += '<div class="p-make"><a href="' + getMakeRRxUrl() + '" target="_blank">我也要制作人人秀</a></div>')), b += "customer" === _copyrightFrom ? '<div class="p-copyright">' + getCopyrightCustomer(!0) + '<span class="show-report">举报</span></div>' : "na" === _copyrightFrom ? '<div class="p-copyright"></div>' : '<div class="p-copyright"><span class="show-report">举报</span><span class="show-copyright"><a href="' + getMakeRRxUrl() + '" target="_blank" style="color:#fff;">' + appConfig.copyright.content + "</a></span></div>", $danmuPanel.html(b), "na" !== _copyrightFrom && registerReportEvent($danmuPanel.find(".p-copyright .show-report")), _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function () {
        ...
        function pageIsHaveTopPlugin(a, b, c, d) {
            ...
            if (void 0 === currentPageId && console.trace(currentPageId), null === e || void 0 === e) return !1;
            var f = e.elementList;
            b = b || "照片投票";
        ...
        function createCopyRightPage2() {
            try {
                if (getCanShowCopyrightPageEnd() && 0 === _dataObj.result && !isOldWsite()) {
                    ...
                    var a = "";
                    _isWxMin ? getIsFromTpl() || (a = '<div class="view-more"> <a class="view-more-button mini-home-button" href="javascript:void(0)"></a> </div>') : a = '<div class="view-more"> <a class="view-more-button" href="#" target="_blank"></a> </div>';
                    var b = '  <div class="rrx-icon-close-layer"> </div> <div class="share-image"> <img src="{{shareImageUrl}}"> </div> <div class="share-title">感恩节</div> ' + a + ' <a href="javascript:void(0)" class="show-rrxiu-report"></a> <div class="bottomm-text" style="{{bgBottomColor}}"> <a class="make-rrxiu" href="#" target="blank"> <span>{{makeRRXText}}</span> </a> </div> <a href="javascript:void(0)" class="show-rrxiu-visit" style="color:#fff;display:{{showVisitCount}}"></a>',
        ...
        function handleAllPageImageThumb() {
            for (var a = _dataObj.pageList, b = 0, c = a.length; c > b; b++) getImageListByPage(a[b])
        }
            ...
            if (null !== a) {
                for (var c = [], d = 0, e = "", f = 0; f < a.elementList.length; f++) {
                    ...
                    if ("img" === h) {
                        ...
                        c = g;
                        for (var k = 0; k < c.length; k++) d = a.elementList[f].width, e = handleImgUrl(c[k].src), filterUserImage(e) && (e += Cool.util.getImageThumb(d, h, e), c[k].src = e), b.push(e);
        ...
        function goToPageById(a) {
            if (!isCurrentToCurrent(a) && (renderPagePart(a, !1), !_isDisableFlipPage)) if ("first" === a) goToPageById(getFirstPageId()); else if ("next" === a) goToNextPage(); else if ("pre" === a) goToPrePage(); else {
                ...
                if (scrolling = !0, _$activePage = getPageDomById(a), _$activePage.length > 0) {
                    var c = _pageIdList.indexOf(parseInt(currentPageId, 10)), d = _pageIdList.indexOf(parseInt(a, 10));
        ...
        var playCount = 0, flip = function () {
                function a(a, b) {
                    if (void 0 !== a) if (h = a,
                            b = void 0 === b ? 0 : b, h.find(".pt-page").each(function () {
        ...
        base.outPage = function (a, b, c) {
            ...
            function m() {
                void 0 !== _dataObj.init && _dataObj.init(), initBone(), initSwipe(), createPages(), 0 === t && 0 === currentPageId ? currentPageId = getFirstPageId() : t > 0 && (currentPageId = t), createProgress(), renderCopyright(), _isPreview && !_isSetting && $previewNotice.show(), pushStateForReadDepth(), void 0 !== _dataObj.loadingpage && void 0 !== _dataObj.loadingpage.title && $loadingpage.html(""), handleAllPageImageThumb(), getFormUseGoods(function () {
                        ...
                        loadExternalJsLibs(function () {
                            ...
                            setTimeout(function () {
                                loading(a, function (a) {
                                    ...
                                    isShowDanmu() && !rrxDanmuJump && (rrxdebug && console.info("initdata-isShowDanmu"), getCommentLikeCount(), getCommentList()), createFocusWechat(), createTopeMenu(), sysMenuBottomCreate(), initSharePoster(), createSharePanel(), initSidleShare(), initSidleReport(), createCopyRightPage2(), _excuteElementEventByBrowser(), i && j && ("rrxiu" === j.copyrightFrom ? (console.log("isSetting is rrxiu"), copyrightPageEndShow()) : copyrightPageEndHideNoAnim()), _rrxtach.recordVisit(apiHelper.getAppInstance().weixinStrong.getWxOpenId())
                                })
                            }, 0)
                        })
                    })
        ...
        var apiHelper = {
            appInstance: null, getAppInstance: function () {
                ...
                this.test = function () {
                    ...
                    if (!a) return a;
                    if (appConfig.dev) return a.indexOf("http:") > -1 ? a : appConfig.dataHost + a;
                ...
                this.wxFocus = new f, this.checkWeixinAlert = checkWeixinAlert, this.log = function (a) {
                ...
                return this.checkOpenMyPrizeDialog = function (a, b, c) {
                    if ("" !== b && void 0 !== b && (Cool.util.checkIsWeixin() || appConfig.dev === !0)) {
                        var d = this.getInteractServiceHost(), e = {activeGuid: a, wxOpenId: b};
                        $.ajax({
                            ...
                            0 === d.result && d.data && c && (g[a + b] || (g[a + b] = !0, c()))
                        }, function (a) {
                        })
                    }
                }, this.checkTimeOver = function (a, b) {
                    var c = this.getInteractServiceHost(), d = {time: a};
                    $.ajax({
                    ...
                    function g(a, b) {
                        ...
                        setTimeout(function () {
                            ...
                            g.off(clickEventType).on(clickEventType, function (b) {
                                ...
                                var c = $(this).data("id"), d = getIndexByArray(a, c, "id");
                                if (d > -1) {
                                    var e = a[d];
                                    e && 1 == e.state && e.exdata && 1 != e.exdata.isApiWay && (e.thirdUrl ? window.location.href = e.thirdUrl : winAlert("奖品链接不可用"))
                                }
                            });
                            ...
                            n.off(clickEventType).on(clickEventType, function (b) {
                                ...
                                if (d > -1) {
                                    var e = a[d];
                                    e && 0 === parseInt(e.state) && (i && f ? (showRRXProcess("加载中..."), j.checkTimeOver(e.createTime, function (a) {
                                        hideRRXProcess(), a ? f(e) : winAlert("奖品超时已失效，无法领取！")
                    ...
                    if (checkWeixinAlert()) {
                        var i = void 0 === f ? !1 : !0, j = this;
                        showRRXProcess("加载中...");
                        var k = this.getInteractServiceHost(), l = {wsiteGuid: a, activeGuid: b, wxOpenId: c};
                        $.ajax({
            ...
            function b(a, b) {
                var c = a.content.token, d = a.content.name, e = a.content.version,
                    f = Cool.util.getPluginDomain(c, e) + "index.js";
                UseAmdLoaderPlugin(d, e) ? b(f, !0) : b(f, !1)
            }

            function c(c, d, e, g) {
                var h = c.content.token, i = c.content.version;
                b(c, function (b, j) {
                    if (j) AmdLoader.require(b, function (a) {
            ...
            function d(c, d) {
                rrxdebug && console.log("loadPlugin"), b(d, function (b, e) {
                    if (e) AmdLoader.require(b, function (a) {
                        a && a.load && a.load(c, d)
                    }); else {
            ...
            function e(c) {
                rrxdebug && console.log("preLoadPlugin"), b(c, function (b, d) {
                    if (d) AmdLoader.require(b, function (a) {
            ...
            function g(c, d) {
                rrxdebug && console.log("leavePlugin"), b(d, function (b, e) {
                    if (e) AmdLoader.require(b, function (a) {
            ...
            return {render: c, load: d, preload: e, add: f, leave: g}
        }()
    }, CoolApp.prototype = {
    ...
    function f(a, b) {
        var c = a.split(","), d = 0 > b ? 0 : 255, e = 0 > b ? -1 * b : b, f = parseInt(c[0].slice(4)),
            g = parseInt(c[1]), h = parseInt(c[2]);
    ...
    function g(a, c, d) {
        ...
        var e = '<div id="win-alert-dialog"></div>',
            ...
            g = b(f, {title: a, isConfirm: void 0 === d ? !1 : d, cancelStyle: d ? "color:#808080" : "color:#36ADF9"}),
            h = $("#win-alert-dialog");
        0 === h.length && ($("#main").append(e), h = $("#win-alert-dialog")), h.html(g), h.show(), h.find(".info-btn-cancel").off().on("click", function (a) {
            a.stopPropagation(), a.preventDefault(), h.hide(), c && c(!1)
        }), h.find(".info-btn-ok").off().on("click", function (a) {
            a.stopPropagation(), a.preventDefault(), c && c(!0), h.hide()
        })
    }
    ...
    function h(a, c, d, e, f) {
        function h() {
            ...
            var e = '<div id="verify-alert-dialog" class="verify-alert-dialogClass"></div>',
                g = '<div class="info-dialog-verify"><div class="verify-content"><div class="verify-image" id="verifyImage-v"><img title="看不清，点击换一张" align="absmiddle" style="vertical-align:middle;border:0"></div><input type="text" name="verify" class="verify-Input element-last" placeholder="输入上方的校验码"></div><div class="verify-error"></div><div class="verify-btn"><a class="verify-btn-cancel" href="javascript:void(0)">取消</a> <a class="verify-btn-ok" href="javascript:void(0)">确定</a></div></div>\n',
                h = b(g, {}), n = $("#verify-alert-dialog");
            0 === n.length && ($("#main").append(e), n = $("#verify-alert-dialog")), n.html(h);
            var o = $("#verifyImage-v"), p = n.find(".verify-error"),
                q = i + "sms/VerifyImage?wsiteGuid=" + j + "&sendPhone=" + l + "&sendType=" + k + "&r=" + Math.random();
            a(), n.show(), o.off().on("click", function () {
                a(), d()
            }), n.find(".verify-btn-cancel").off().on("click", function () {
                n.hide(), f && f(m)
            }), n.find(".verify-btn-ok").off().on("click", function () {
                var b = $.trim(n.find(".verify-Input").val());
                if (!b) return void c("请输入校验码");
                var d = {wsiteGuid: j, sendPhone: l, sendType: k, verify: b};
                $.post(i + "sms/VerifySend", {form: d}, function (b) {
                    0 === b.result ? (n.hide(), m.isVerify = !0, m.data = b.data, f && f(m)) : (c(b.msg), a())
                })
            })
        }

        var i = a, j = c, k = e, l = d, m = {isVerify: !1, data: null};
        if (!window.hasSmsVerify) {
            window.hasSmsVerify = !0;
            var n = {wsiteGuid: j, sendPhone: l, sendType: k};
            $.post(i + "sms/Verify", {form: n}, function (a) {
                window.hasSmsVerify = !1, 0 === a.result ? a.data.isVerify ? h() : f && (m.isVerify = !0, m.data = a.data, f(m)) : g(a.msg)
            })
        }
    }
    ...
    function i(a, c, d, e) {
        function f() {
            ...
            var f = '<div id="verify-lottery-alert-dialog" class="verify-alert-dialogClass"></div>',
                k = '<div class="info-dialog-verify"><div class="verify-content"><div class="verify-image" id="verifyImage-v"><img title="看不清，点击换一张" align="absmiddle" style="vertical-align:middle;border:0"></div><input type="text" name="verify" class="verify-Input element-last" placeholder="输入上方的校验码"></div><div class="verify-error"></div><div class="verify-btn"><a class="verify-btn-cancel" href="javascript:void(0)">取消</a> <a class="verify-btn-ok" href="javascript:void(0)">确定</a></div></div>\n',
                l = b(k, {}), m = $("#verify-lottery-alert-dialog");
            0 === m.length && ($("#main").append(f), m = $("#verify-lottery-alert-dialog")), m.html(l);
            var n = $("#verifyImage-v"), o = m.find(".verify-error"),
                p = g + "sms/VerifyLotteryImage?wsiteGuid=" + h + "&wxOpenId=" + i + "&r=" + Math.random();
            a(), m.show(), n.off().on("click", function () {
                a(), d()
            }), m.find(".verify-btn-cancel").off().on("click", function () {
                m.hide(), e && e(j)
            }), m.find(".verify-btn-ok").off().on("click", function () {
                var b = $.trim(m.find(".verify-Input").val());
                if (!b) return void c("请输入校验码");
                var d = {wsiteGuid: h, wxOpenId: i, verify: b};
                $.post(g + "generalPrize/VerifyCode", {form: d}, function (b) {
                    0 === b.result ? (m.hide(), j.isVerify = !0, j.data = b.data, e && e(j)) : (c(b.msg), a())
                })
            })
        }

        var g = a, h = c, i = d, j = {isVerify: !1, data: null};
        f()
    }
    ...
    function j(a, c, d, e, f) {
        function g() {
            function a() {
                p.find(".verify-Input").val(""), q.find("img").attr("src", s)
            }
            ...
            var e = "verify-active-alert-dialog",
                g = '<div id="verify-active-alert-dialog" class="verify-alert-dialogClass"></div>',
                n = '<div class="info-dialog-verify"><div class="verify-content"><div class="verify-image" id="verifyImage-v"><img title="看不清，点击换一张" align="absmiddle" style="vertical-align:middle;border:0"></div><input type="text" name="verify" class="verify-Input element-last" placeholder="输入上方的校验码"></div><div class="verify-error"></div><div class="verify-btn"><a class="verify-btn-cancel" href="javascript:void(0)">取消</a> <a class="verify-btn-ok" href="javascript:void(0)">确定</a></div></div>\n',
                o = b(n, {}), p = $("#" + e);
            0 === p.length && ($("#main").append(g), p = $("#" + e)), p.html(o);
            var q = $("#verifyImage-v"), r = p.find(".verify-error"),
                s = h + "sms/VerifyActiveImage?wsiteGuid=" + i + "&guid=" + k + "&wxOpenId=" + j + "&r=" + Math.random();
            a(), p.show(), q.off().on("click", function () {
                a(), d()
            }), p.find(".verify-btn-cancel").off().on("click", function () {
                p.hide(), f && f(m)
            }), p.find(".verify-btn-ok").off().on("click", function () {
                var b = $.trim(p.find(".verify-Input").val());
                return b ? (l.code = b, l.close = function () {
                    p.hide()
                }, l.showError = c, l.refresh = a, void(f && f(l))) : void c("请输入校验码")
            })
        }

        var h = a, i = c, j = e, k = d, l = {code: "", event: "ok", close: null}, m = {code: "", event: "cancel"};
        g()
    }
    ...
    function k() {
        var a = '<div id="rrx-process-dialog"></div>',
            ...
            d = b(c, {}), e = $("#rrx-process-dialog");
        return 0 === e.length && ($("#main").append(a), e = $("#rrx-process-dialog"), e.html(d)), e
    }

    function l() {
        var a = '<div id="rrx-tips-dialog"><span>请稍等</span></div>', c = b(a, {}), d = $("#rrx-tips-dialog");
        return 0 === d.length && ($("#main").append(c), d = $("#rrx-tips-dialog")), d
    }
    ...
    function q(a, c, d, e) {
        function f() {
            s.find(".afteronline-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), s.show()
        }

        function g(a) {
            s.find(".afteronline-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                s.hide(), a && a()
            }, 600)
        }
        ...
        function h() {
            v.off().on(t, function (a) {
                a.preventDefault(), g(function () {
                    e && (u.event = "closeEvent", u.result = 0, e(u))
                })
            })
        }

        function i() {
            var a = s.find(".content-qr"), b = new QRCode(a[0], {width: 300, height: 300});
            b.makeCode(q)
        }

        var j = a, k = (j.getInteractServiceHost(), j.getLibHost()), l = j.getWsiteCanvas().find(".pt-inner"),
            m = "prize-afteronline-dialog", n = '<div class="' + m + '"></div>',
            ...
            p = k + "weplus/image/close.png", q = c.openCode, r = b(o, {closeImage: p, prizeCode: q}),
            s = l.find("." + m);
        0 === s.length && (l.append(n), s = l.find("." + m)), s.html(r);
        var t = "click", u = {event: "closeEvent", result: 0}, v = s.find(".content-close-img");
        i(), h(), f()
    }

    function r(a, c, d, e) {
        function f() {
            q.find(".wxpublic-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), q.show()
        }

        function g(a) {
            q.find(".wxpublic-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                q.hide(), a && a()
            }, 600)
        }
        ...
        function h() {
            t.off().on(r, function (a) {
                a.preventDefault(), g(function () {
                    e && (s.event = "closeEvent", s.result = 0, e(s))
                })
            })
        }

        var i = a, j = (i.getInteractServiceHost(), i.getLibHost()), k = i.getWsiteCanvas().find(".pt-inner"),
            l = "prize-wxpublic-dialog", m = '<div class="' + l + '"></div>',
            ...
            p = b(n, {closeImage: o, prizeCode: c.openCode, appQrUrl: c.appQrUrl, appName: c.appName || ""}),
            q = k.find("." + l);
        0 === q.length && (k.append(m), q = k.find("." + l)), q.html(p);
        var r = "click", s = {event: "closeEvent", result: 0}, t = q.find(".content-close-img");
        h(), f()
    }

    function s(a, c, e, f) {
        function g() {
            E.find(".winTest svg path").css({fill: e}), E.find(".winTest svg  g path").css({fill: "#fff"}), E.find(".winTest svg polygon").eq(1).css({fill: e}), E.find(".dialog-content").css({background: "linear-gradient(to bottom, " + p + " 0%," + e + " 100%)"}), E.find(".content-action").find("svg path").css({fill: e}), E.find(".winPrize-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), E.show()
        }

        function h(a) {
            E.find(".winPrize-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                E.hide(), a && a()
            }, 600)
        }
        ...
        0 === E.length && (k.append(n), E = k.find("." + m)), E.html(D);
        var F = "click", G = {event: "closeEvent", result: 0}, H = E.find(".content-action"),
    ...
    function t(a, c, e, f) {
        function g() {
            E.find("svg path").css({fill: e}), E.find(".loseTest svg path").css({fill: e}), E.find(".loseTest svg g path").css({fill: "#fff"}), E.find(".dialog-content").css({background: "linear-gradient(to bottom, " + p + " 0%," + e + " 100%)"}), E.find(".content-action").find("svg path").css({fill: e}), E.find(".noPrize-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), E.show()
        }

        function h(a) {
            E.find(".noPrize-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                E.hide(), a && a()
            }, 600)
        }
        ...
        function i() {
            H.off().on(F, function (a) {
                a.preventDefault(), h(function () {
                    f && (G.event = "closeEvent", G.result = 0, f(G))
                })
            }), I.off().on(F, function (a) {
                a.preventDefault(), h(function () {
                    f && (G.event = "closeEvent", G.result = 0, f(G))
        ...
        var j = a, k = j.getWsiteCanvas().find(".pt-inner"), l = j.getLibHost(), m = "rrx-prizeno-dialog",
            n = '<div class="' + m + '"></div>',
            ...
            p = d(e, .4), q = "background-color:#fff;box-shadow: 2px 12px 1Px " + p + " ;",
            r = l + "weplus/image/close.png", s = l + "weplus/image/prizeBg1.png",
            t = l + "weplus/image/prizeInfoBg1.png", u = z.cry, v = z.knowBtn, w = z.loseTest, x = e, y = 50,
            A = c.content;
        A && (A.length > 6 && A.length <= 12 ? y = 40 : A.length > 12 && (y = 30));
        var B = c.hasShare, C = 1;
        c.shareChanceCount && (C = c.shareChanceCount);
        var D = b(o, {
            closeImage: r,
            bgImage: s,
            failText: u,
    ...
    function u(a, c, e, f, i, j, k) {
        function l() {
            K.find(".prizeget-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), K.show()
        }

        function m(a) {
            K.find(".prizeget-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                K.hide(), a && a()
            }, 600)
        }

        function n() {
            O.off().on(M, function (a) {
                a.preventDefault();
                var b = u();
                b && (console.log("data", b), f ? (N.event = "submitEvent", N.result = b, N.closeCallBack = m, f(N)) : m())
            }), P.off().on(M, function (a) {
                a.preventDefault();
                var b = s(K);
                if (r(b)) {
                    var c = K.find(".btn-smscode"), d = K.find(".input-award-smscode");
                    q(b, c, d)
                } else g("请输入正确的手机号码！")
            }), Q.off().on(M, function (a) {
                a.preventDefault(), m(function () {
                    f && (N.event = "giveupEvent", N.result = 0, f(N))
                })
            })
        }

        function o(a) {
            R = 60, a.html(R + "s"), a.css("background-color", "#e7e7e7"), a.css("color", "#686868"), L = setInterval(function () {
                R -= 1, 0 === R ? p(a) : a.html(R + "s")
            }, 1e3)
        }

        function p(a) {
            L && clearInterval(L), a.html("获取验证码"), a.css("background-color", e), a.css("color", "#fff")
        }

        function q(a, b, c) {
            if (0 === R) {
                var d = v.getInteractServiceHost(), e = v.getWsiteGuid();
                h(d, e, a, "", function (a) {
                    a.isVerify && o(b)
                })
            }
        ...
        function s(a) {
            for (var b = F, c = 0; c < b.length; c++) if ("telephone" === b[c].type && "手机" === b[c].name) {
        ...
        function u() {
            for (var a = [], b = F, c = "", d = 0; d < b.length; d++) {
                var e = K.find(".input-award-" + b[d].id), f = e.val().trim();
                if (!f) return g(b[d].name + "不能为空"), !1;
                if ("telephone" === b[d].type) {
                    if (!r(f)) return g("输入的手机号码格式不正确！"), !1;
                    if ("true" === b[d].smscode) {
                        var h = K.find(".input-award-smscode");
                        if ("" === $.trim(h.val())) return g("验证码不能为空！"), !1;
                        c = {}, c.sendPhone = f, c.codeValue = h.val().trim()
                    }
                }
                if ("mail" === b[d].type) {
                    var i = /^(\S)+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/;
                    if (!i.test(f)) return g("输入的邮箱格式不正确！"), !1
                }
                a.push({
                    id: b[d].id,
                    name: b[d].name,
        ...
        var v = a, w = v.getWsiteCanvas().find(".pt-inner"), x = v.getLibHost(), y = "rrx-prizeget-dialog",
            A = '<div class="' + y + '"></div>',
            ...
            C = d(e, .4), D = x + "weplus/image/close.png", E = e, F = t(c), G = "<header >完善领奖信息</header>",
            H = z.activeBtn;
        i && (G = "<header >完善报名信息</header>", H = z.applyBtn), j = j || [], k = k || {}, k.isPay && (G = "<header >完善收货信息</header>", H = "立即支付");
        var I = k.leftTime || "", J = b(B, {
            activeTitle: G,
            awardModel: F,
            closeTag: D,
            pFromBg: E,
        ...
        0 === K.length && (w.append(A), K = w.find("." + y)), K.html(J);
        var L, M = "click", N = {event: "closeEvent", result: 0}, O = K.find(".submit-form"),
            P = K.find(".btn-smscode"), Q = K.find(".closeBtn"), R = 0;
        n(), l()
    }
    ...
    function v(a, b, c, d, e, f, g) {
        function h(c) {
            if ("submitEvent" == c.event) {
                var d = c.result, f = a.getInteractServiceHost(), g = a.getWsiteGuid(),
                    h = a.weixinStrong.getIdentifyId(), i = {
                        wsiteGuid: g,
                        activeGuid: b,
                        identify: h,
                ...
                j(f, h, g, i)
            } else "giveupEvent" == c.event && e && (k.event = "closeEvent", k.result = 0, e(k))
        }

        function j(b, c, g, h) {
            h && (h.fg = a.getFg()), $.post(b + "generalPrize/PresetApply", {form: h}, function (l) {
                if (0 === l.result) e && (k.event = "okEvent", k.result = 0, e(k)), h.closeCallBack && h.closeCallBack(); else {
                    if (4500 == l.result) {
                        var m = a.getInteractServiceHost();
                        return void i(m, g, c, function (a) {
                            a && a.isVerify ? j(b, c, g, h) : (k.event = "closeEvent", e(k))
                        })
                    }
                    k.result = l.msg, f || w(a, l.msg, d), e && (k.event = "errorEvent", e(k))
                }
            })
        }

        var k = {event: "closeEvent", result: 0};
        u(a, c, d, h, !0, g)
    }

    function w(a, c, e, f, g, h) {
        function i() {
            y.find(".content-info-inner").html(c), y.find(".dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), y.show()
        }

        function j(a) {
            y.find(".dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                y.hide(), a && a()
            }, 600)
        }

        function k() {
            C.off().on(A, function (a) {
                j(function () {
                    f && (B.event = "sureEvent", B.result = 0, f(B))
                })
            }), D.off().on(A, function (a) {
                a.preventDefault(), j(function () {
                    f && (B.event = "closeEvent", B.result = 0, f(B))
                })
            })
        }
        ...
        var m = l.getWsiteCanvas().find(".pt-inner"), n = a.getLibHost(), o = "rrx-prizeinfo-dialog",
            p = '<div class="' + o + '"></div>',
            ...
            r = "background-color:#fff;border:4px solid  " + e + " ;", s = d(e, .4),
            t = "background-color:" + e + ";box-shadow: 2px 12px 1Px " + s + " ;", u = n + "weplus/image/close.png",
            v = e, w = z.knowBtn;

        g && h ? w = b(z.changeLinkBtn, {linkUrl: h, linkName: g}) : g && (w = b(z.customerBtn, {linkName: g}));
        var x = b(q, {dialogBorder: r, closeImage: u, textColor: v, actionCss: t, btn: w}), y = m.find("." + o);
        0 === y.length && (m.append(p), y = m.find("." + o)), y.html(x);
        var A = "click", B = {event: "ticketEvent", result: 0}, C = y.find(".content-action"),
    ...
    function x(a, e, f, g) {
        function h() {
            A.find(".dialog-content-left svg path").css({fill: f}), A.find(".dialog-content-left svg  g path").css({fill: "#fff"}), A.find(".dialog-content-info-text-title").css({color: f}), x && (A.find(".detail-text")[0].innerText = x), A.find(".prizedetail-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), A.show()
        }

        function i(a) {
            A.find(".prizedetail-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                A.hide(), a && a()
            }, 600)
        }
        ...
        function j() {
            D.off().on(B, function (a) {
                a.preventDefault(), i(function () {
                    g && (C.event = "closeEvent", C.result = 0, g(C))
                })
            })
        }

        function k() {
            var a = A.find(".dialog-content-info-text-detail");
            c(a[0])
        }

        var l = a, m = l.getWsiteCanvas().find(".pt-inner"), n = l.getLibHost(), o = "rrx-prizedetail-dialog",
            p = '<div class="' + o + '"></div>',
            ...
            r = (d(f, .4), n + "weplus/image/close.png"), s = n + "weplus/image/detailBg.png", t = z.winDetail, u = f,
            v = e.name || "", w = e.image || "http://image3.weplus.me/2016/07/20/1468986497159.png", x = e.detail,
            y = b(q, {closeImage: r, bgImage: s, winDetail: t, prizeName: v, prizeImage: w, textColor: u}),
            A = m.find("." + o);
        0 === A.length && (m.append(p), A = m.find("." + o)), A.html(y);
        var B = "click", C = {event: "closeEvent", result: 0}, D = A.find(".content-close-img");
        k(), j(), h()
    }

    function y(a, d, e, f, g) {
        function h() {
            p.find(".dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), p.find(".content-close").removeClass("bounceOutUpAni").addClass("bounceInUpAni"), p.show()
        }

        function i(a) {
            p.find(".dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), p.find(".content-close").removeClass("bounceInUpAni").addClass("bounceOutUpAni"), setTimeout(function () {
                p.hide(), a && a()
            }, 600)
        }
        ...
        var k = a.getWsiteCanvas().find(".pt-inner"), l = a.getLibHost(), m = l + "weplus/image/close.png",
            n = "rrx-common-dialog",
            ...
            p = k.find("." + n), q = g || "我的奖品";
        if (0 === p.length) {
            var r = b(o, {closeIcon: m, baseColor: e, basicCss: n, name: q, content: d.content});
            k.append(r), p = k.find("." + n)
        } else p.find(".scroll-list .content-list").html(d.content);
        var s = "click", t = p.find(".content-close");
        return j(), h(), c(p.find(".dialog-content-box").get(0)), {closeEvent: i}
    }

    a.winAlert = g, a.verifyAlert = h, a.verifyLotteryAlert = i, a.verifyActiveAlert = j, a.showRRXProcess = m, a.hideRRXProcess = n, a.showRRXTips = o, a.hideRRXTips = p, a.showRRXAfterOnlineDialog = q, a.showRRXWxPuplicDialog = r, a.showRRXWinPrizeDialog = s, a.showRRXNoPrizeDialog = t, a.showRRXGetPrizeDialog = u, a.showRRXPresetFormDialog = v, a.showRRXPrizeInfoDialog = w, a.showRRXPrizeDetailDialog = x, a.showRRXCommonDialog = y, a.fnColorThin = d, a.compileHtml = b;
    var z = {
...
}(window), window.rrxSharePosterCreator = window.rrxSharePosterCreator || {}, function () {
    function a(a) {
        if (a) {
            ...
            b > -1 && (a = a.substr(0, b));
            var d = a.indexOf("@!");
            return d > -1 && (a = a.substr(0, d)), a + K + "?v=" + c()
        }
        return x
    }
