    ...
    <div class="row flex-xl-nowrap">
        ...
        <div class="main-container ant-col-xs-24 ant-col-sm-24 ant-col-md-18 ant-col-lg-19">
            <article class="markdown">
                ...
                <ol>
                    <li>1.简化安装过程及文档，增加了图文安装过程</li>
                    <li>2.事项的附件可以通过移动端扫码上传</li>
                    <li>3.增加了首页的自定义面板功能，每个用户可以管理和排列首页内容</li>
                    <li>4.不再支持Sphinx全文搜索引擎，Mysql版本建议使用5.7或以上的版本</li>
                    <li>5.增加了左侧菜单选项</li>
                    <li>6.删除了许多不必要的文件，完整代码包大小由原来的70多M减少到45M</li>
                    <li>7.增加了收集用户基本信息（非重要或敏感）的功能</li>
                    <li>...</li>
                    <p></p>
