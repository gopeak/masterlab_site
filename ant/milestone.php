    ...
    <div class="row flex-xl-nowrap">
        ...
        <div class="main-container ant-col-xs-24 ant-col-sm-24 ant-col-md-18 ant-col-lg-19">
            <article class="markdown">
                ...
                <ol>
                    <li>增加在线升级判断</li>
                    <li>修复待办事项和迭代页面的创建表单错误</li>
                    <li>优化v1.0-v2.0的升级脚本</li>
                </ol>
                <h2>v2.0.1 更新</h2>
                <p>2020-3-6，新增甘特图模块，创新的将事项分解和思维导图进行整合</p>
                <p>新功能：</p>
                <ol>
                    <li>增加了在线升级的功能</li>
                    <li>修复自定义过滤器无法查询的bug</li>
                    <li>增加了一些标签的title属性</li>
                </ol>
                <h2>v2.0 版本发布</h2>
                <p>2020-3-4，新增甘特图模块，创新的将事项分解和思维导图进行整合</p>
                <p>新功能：</p>
                <ol>
                ...
                <h2>v1.2 版本发布</h2>
                <p>2020-7-28 新增多项实用功能和优化改进项，同时修复大量bug</p>
                <p>新功能和优化改进有:</p>
                <ol>
                    <li>增加项目成员管理功能</li>
